...
const times = ['09:00 AM', '09:30 AM', '10:00 AM', '11:00 AM', '02:00 PM', '02:30 PM', '03:00 PM', '04:30 PM'];
  ...
  return (
    <View style={ui.screen}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.timeGrid}>{times.slice(0, 4).map((time) => <TimeButton key={time} time={time} selected={selectedTime === time} taken={bookedTimes.has(time)} onPress={() => selectTime(time)} />)}</View>
        <Text style={styles.period}>AFTERNOON</Text>
        <View style={styles.timeGrid}>{times.slice(4).map((time) => <TimeButton key={time} time={time} selected={selectedTime === time} taken={bookedTimes.has(time)} onPress={() => selectTime(time)} />)}</View>
